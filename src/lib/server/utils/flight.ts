...
export const validateAndSaveFlight = async (
  ...
  if (data.datePrecision !== 'day') {
    ...
    const values = {
      ...
      departureRunwayId: departureRunwayId ?? null,
      departureRunwayEnd: departureRunwayEnd ?? null,
      arrivalRunwayId: arrivalRunwayId ?? null,
      arrivalRunwayEnd: arrivalRunwayEnd ?? null,
