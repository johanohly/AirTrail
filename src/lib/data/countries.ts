export const COUNTRIES = [
  ...
  { name: 'British Virgin Islands', alpha2: 'VG', alpha3: 'VGB', numeric: 92 },
  { name: 'Brunei', alpha2: 'BN', alpha3: 'BRN', numeric: 96 },
  { name: 'Bulgaria', alpha2: 'BG', alpha3: 'BGR', numeric: 100 },
  { name: 'Burkina Faso', alpha2: 'BF', alpha3: 'BFA', numeric: 854 },
  { name: 'Burma', alpha2: 'MM', alpha3: 'MMR', numeric: 104 },
  ...
  { name: 'Congo, Republic of the', alpha2: 'CG', alpha3: 'COG', numeric: 178 },
  ...
  { name: 'Curacao', alpha2: 'CW', alpha3: 'CUW', numeric: 531 },
  ...
  { name: 'France, Metropolitan', alpha2: 'FX', alpha3: 'FXX', numeric: 249 },
  ...
  { name: 'Gaza Strip', alpha2: 'PS', alpha3: 'PSE', numeric: 275 },
  ...
  { name: 'Korea, North', alpha2: 'KP', alpha3: 'PRK', numeric: 408 },
  { name: 'Korea, South', alpha2: 'KR', alpha3: 'KOR', numeric: 410 },
  { name: 'Kosovo', alpha2: 'XK', alpha3: 'XKS', numeric: 0 },
  { name: 'Kuwait', alpha2: 'KW', alpha3: 'KWT', numeric: 414 },
  { name: 'Kyrgyzstan', alpha2: 'KG', alpha3: 'KGZ', numeric: 417 },
  { name: 'Laos', alpha2: 'LA', alpha3: 'LAO', numeric: 418 },
  ...
  { name: 'Moldova', alpha2: 'MD', alpha3: 'MDA', numeric: 498 },
  ...
  { name: 'Pitcairn Islands', alpha2: 'PN', alpha3: 'PCN', numeric: 612 },
  ...
  { name: 'Saint Barthelemy', alpha2: 'BL', alpha3: 'BLM', numeric: 652 },
  {
  ...
  { name: 'Saint Martin', alpha2: 'MF', alpha3: 'MAF', numeric: 663 },
  {
  ...
  { name: 'Sint Maarten', alpha2: 'SX', alpha3: 'SXM', numeric: 534 },
  ...
  { name: 'Turkey (Turkiye)', alpha2: 'TR', alpha3: 'TUR', numeric: 792 },
  ...
  { name: 'Virgin Islands', alpha2: 'VI', alpha3: 'VIR', numeric: 850 },
  { name: 'Wallis and Futuna', alpha2: 'WF', alpha3: 'WLF', numeric: 876 },
  { name: 'West Bank', alpha2: 'PS', alpha3: 'PSE', numeric: 275 },
