...
<CardGrid>
  <LinkCard title="Docker Compose" link="/docs/install/docker-compose" />
  <LinkCard title="Portainer" link="/docs/install/portainer" />
  <LinkCard title="Synology NAS" link="/docs/install/synology" />
  <LinkCard title="Manual" link="/docs/install/manual" />
</CardGrid>
