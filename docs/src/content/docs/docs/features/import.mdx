...
Currently, AirTrail supports importing flights from <Link href={'https://my.flightradar24.com'}>MyFlightRadar24</Link>
, <Link href={'https://appintheair.com'}>App in the Air</Link>, <Link href={'https://github.com/pbogre/jetlog'}>JetLog</Link>
and <Link href={'/docs/features/export'}>AirTrail JSON files</Link>.
