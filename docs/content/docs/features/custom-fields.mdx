...
Required custom fields are enforced server-side for both create and update requests. The legacy `seats` request property remains accepted, but new integrations should use `passengers`.
